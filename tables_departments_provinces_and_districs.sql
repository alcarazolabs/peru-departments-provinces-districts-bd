...
-- Tiempo de generación: 09-08-2021 a las 02:38:16
...
ALTER TABLE `districts`
  ...
  ADD KEY `fk_district_department_id` (`department_id`);
...
--
ALTER TABLE `districts`
  ADD CONSTRAINT `fk_district_department_id` FOREIGN KEY (`department_id`) REFERENCES `departments` (`id`),
